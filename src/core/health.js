...
export async function launch({ port, kill_existing, _deps } = {}) {
  ...
  if (!tvPath && platform === 'win32') {
    ...
    try {
      const ps = 'powershell -NoProfile -Command "(Get-AppxPackage -Name \'*TradingView*\' -ErrorAction SilentlyContinue | Select-Object -First 1 -ExpandProperty InstallLocation)"';
